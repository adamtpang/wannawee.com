...
export const amenities = pgTable("amenities", {
  ...
  type: text("type").notNull(), // 'prayer_room'
  name: text("name"),
  ...
  denomination: text("denomination"), // 'muslim', 'christian', 'jewish', 'buddhist', 'hindu', 'multi_faith', 'non_denominational'
  gender: text("gender"), // 'male', 'female', 'unisex', 'separate'
  ablutionFacilities: boolean("ablution_facilities"), // washing facilities for Muslims
  prayerMats: boolean("prayer_mats"), // prayer mats available
  qiblaDirection: boolean("qibla_direction"), // qibla direction marked
  quietSpace: boolean("quiet_space"), // dedicated quiet/meditation space
  shoesRemoval: boolean("shoes_removal"), // shoes must be removed
  building: boolean("building"), // if prayer room is in a building
  capacity: integer("capacity"), // approximate number of people
  supervisor: text("supervisor"), // who manages the space
  accessType: text("access_type"), // 'public', 'customers', 'residents', 'employees', 'students'

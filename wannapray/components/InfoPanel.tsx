...
export default function InfoPanel({ markerData, userLocation, onClose }: InfoPanelProps) {
      ...
      <CardContent className="p-4">
        <div className="flex items-start justify-between mb-3">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">{amenity.name || 'Public Facility'}</h3>
        ...
        <Tabs defaultValue="info" className="w-full">
          ...
          <TabsContent value="info" className="mt-4">
            ...
            {distance && (
              <p className="text-sm text-gray-600 mb-3">📍 {distance.toFixed(1)} km away</p>
            )}
